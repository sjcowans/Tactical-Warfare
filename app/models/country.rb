class Country < ApplicationRecord
  ...
  def air_to_armor_attack(attacker, defender, battle_report)
    ...
    defender_armor_health = (defender.air_armored * 50) + (defender.sea_armored * 150) + (defender.basic_armored * 100) + (defender.armor_armored * 500)
  ...
  def air_to_navy_attack(attacker, defender, battle_report)
    ...
    defender_navy_health = (defender.air_ship * 20000) + (defender.sea_ship * 15000) + (defender.basic_ship * 5000) + (defender.armor_ship * 30000)
